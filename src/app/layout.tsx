...
export const metadata: Metadata = {
  ...
  description: "Downtown Realty, along with subsidiary Omshirdisai Maa Construction Pvt Ltd, provides expert real estate solutions in Patna. From luxury apartments, commercial spaces and ready-to-move flats to residential plots in Omshirdi Sai City, we build dreams across Bihar.",
