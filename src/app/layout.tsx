...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [ 
      {
        url: "https://downtownrealtyj.com/og-image.png",
        width: 1200,
        height: 630,
